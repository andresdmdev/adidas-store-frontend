...
import { menuMovil, selectMenuMovil, selectShowSingleProduct, singleProduct } from "../../../../services/slices/validationSlice";
    ...
    <div className='header_movil'>
      {
        ...
        <div onClick={handleClick} className='header_movil_back'>
          <img src={backLogo} alt="back-logo" className="header_movil_back_logo" />
        </div> :
        <img src={profil} alt="profil" className='header_movil_profil' />
      }
      <img src={logo} alt="logo" className='header_movil_logo' />
      <div className={`header_movil_menu_logo ${!menu && 'ligth'}`} onClick={handleMenu}>
        <img src={menu ? menuLogo : menuLigth} alt="menu-logo" className={`header_movil_menu_logo_icon ${!menu && 'ligth'}`} />
      </div>
    </div>
  )
}